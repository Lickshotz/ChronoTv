...
<body>
  ...
  include 'connect_DB.php';
    ...
    if($q == 0){
            ...
            $query = "SELECT m.MID,.m.Name,Source1,Source2 FROM Media m JOIN User u ON u.UID = m.User WHERE OfType = 'YT' AND u.Public = 0";
			...
			if (!$result)
			{
			  echo "<tr>
				...
				while ($row = mysqli_fetch_array($result))
				{
				  ...
				  echo "<tr>";
                    echo "<td>". $i ."</td>";
                    echo "<td><iframe width='300' height='200' src='https://www.youtube.com/embed/". $row['Source1'] . "' frameborder='0' allowfullscreen></iframe></td>";
                    echo "<td>". $row['Name'] . "</td>";
			...
			$query = "SELECT m.MID,.m.Name,Source1,Source2 FROM Media m JOIN User u ON u.UID = m.User WHERE OfType = 'YT' AND u.Public = 0 AND m.User = '".$q."'";
