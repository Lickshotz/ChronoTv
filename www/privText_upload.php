...
<script>
    ...
    function showUser(str) {
        ...
        if (str == "") {
            ...
            xmlhttp.open("GET", "privgettexte.php?q=" + str, true);
            xmlhttp.send();
        }
    }
    function del(){
...
<body class="privat">
    ...
    <div class="nav">
        ...
        <div class="ueberschrift"><i class="fa fa-file-text-o" aria-hidden="true"></i></i> <u>Texte</u></div>
    ...
    <!-------- Hochladen ------------>
    <div class="auswahlboxen Textver upload">
  ...
  height: 150px;"></textarea>
    ...
    <div class="auswahlboxen Textver">
        <legend>Texte nach Usern geordnet</legend>
