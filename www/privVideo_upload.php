...
<script>
    ...
    function showUser(str) {
        ...
        if (str == "") {
            ...
            xmlhttp.open("GET", "privgetvideos.php?q=" + str, true);
            xmlhttp.send();
        }
    }
    function del(){
...
<body class="privat">
    ...
    <div class="nav">
        ...
        <div class="ueberschrift"><i class="fa fa-video-camera" aria-hidden="true"></i></i> <u>Videos</u></div>
    ...
    <!-------- Hochladen ------------>
    <div class="auswahlboxen videover upload">
        <legend>Hochladen</legend>
        <form action="upload.php" method="post" enctype="multipart/form-data">
            <input type="hidden" value="YT" name="type">
            <div class="uploadBox">
                <span class="headline">1. Link und Name eingeben</span> <i class="fa fa-video-camera" aria-hidden="true"></i>
                <br><br>
                <input type="text" name="name" value="Name des Videos"></br>
                </br>
                <input type="text" name="link" value="Link des Videos">
            </div>
            <div class="uploadBox">
                <span class="headline">2. Benutzer wählen  <i class="fa fa-folder" aria-hidden="true"></i></span>
                <br><br>
  ...
  height: 150px;"></textarea>
    ...
    <div class="auswahlboxen videover">
        <legend>Videos nach Usern geordnet</legend>



        <select name="user" class="choose" onchange="showUser(this.value)" onLoad="showUser(this.value)" value="0">
                <option value="" selected>Bitte ein Benutzer wählen...</option>
        ...
        <div class="buttonThema btn btn-lg" onclick="location.href='benutzerVerwaltung.php'">
            <i class="fa fa-plus" aria-hidden="true"></i> Benutzer hinzufügen
        </div>
