  ...
  <html lang = "de">
   ...
   <script>
    ...
    if (str == "") {
        ...
        xmlhttp.open("GET","privgetaudio.php?q="+str,true);
        xmlhttp.send();
    }
}
       function del(){
...
<!---- NAV MENU ------>
    ...
    <div class ="nav">
		...
		<div class="ueberschrift"><i class="fa fa-music" aria-hidden="true"></i></i> <u>Musik</u></div>
...
<!-------- Hochladen ------------>
<div class="auswahlboxen musikver upload">
	...
	<form action="upload.php" method="post" enctype="multipart/form-data">
        ...
        <div class="uploadBox">
            <span class="headline">3. Beschreibung/Lyrics hinzufügen <i class="fa fa-pencil" aria-hidden="true"></i></span>
            <br><br>
...
<div class="auswahlboxen musikver">
<legend>Musik nach Usern geordnet</legend>
