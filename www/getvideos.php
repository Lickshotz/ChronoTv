...
<body>
  ...
  include 'connect_DB.php';
    ...
    if($q == 0){
            ...
            $query = "SELECT m.MID,.m.Name,Source1,Source2 FROM Media m JOIN User u ON u.UID = m.User WHERE OfType = 'YT' AND u.Public = 1";
			...
			$query = "SELECT m.MID,.m.Name,Source1,Source2 FROM Media m JOIN User u ON u.UID = m.User WHERE OfType = 'YT' AND u.Public = 1 AND m.User = '".$q."'";
